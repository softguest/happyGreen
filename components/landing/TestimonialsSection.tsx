...
const TESTIMONIALS = [
  {
    ...
    quote:
      "GreenSkill Hub helped me turn kitchen waste into income. The AI recommended composting based on my location, and the business planner helped me price my products. I now earn 80,000 XAF monthly!",
    avatar: "AB",
    rating: 5,
  },
  {
