...
export function PlanPDFExport({ plan, skillName }: Props) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      addText("GreenSkill Up", 10, false, [200, 230, 200]);
      doc.text("GreenSkill Up — Green Business Plan", margin, 14);
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        doc.text(
          `GreenSkill Up — AI-Powered Green Business Plan | Page ${i} of ${totalPages}`,
          margin,
